...
const NotificationIconButton = ({action, active}: { action: () => void, active: boolean }) => {
    return (
        active ? (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6 text-commerz-500">
                <path
            ...
            {accounts.map((account, index) => {
                ...
                const defineChart = () => {
                    switch (account.recommendationScore) {
                        ...
                        case 3:
                            return <Image src={Three} alt={"test"} width={320} height={180}/>;
                        case 4:
