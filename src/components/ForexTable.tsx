...
const data: CurrencyData[] = [
    ...
    },
    {
        ...
        highestLastWeek: 9.20,
        highestLastMonth: 9.25,
        lowestLastWeek: 9.10,
        lowestLastMonth: 9.00,
    },
];
...
const getColorForRate = (
    ...
    console.log(`currentRate${currentRate}`, `highestLastWeek${highestLastWeek}`, `highestLastMonth${highestLastMonth}`);
                ...
                {data.map((currency) => {
                    ...
                    return (
                        <tr key={currency.currency} className="border-b">
                            ...
                            <td className="px-4 py-2">{currency.highestLastWeek.toFixed(2)}</td>
                            <td className="px-4 py-2">{currency.highestLastMonth.toFixed(2)}</td>
                            <td className="px-4 py-2">{currency.lowestLastWeek.toFixed(2)}</td>
                            <td className="px-4 py-2">{currency.lowestLastMonth.toFixed(2)}</td>
                            <td className="px-4 py-2">
                                <span className={`w-4 h-4 rounded-full inline-block ${trendColor}`}></span>
                            </td>
                        </tr>
                    );
                })}
