...
const DiversifiedProgressBar2: React.FC = () => {
    ...
    return (
        <div className="p-4">
            <h1 className="text-2xl font-bold mb-4">Currency Diversification (Forex)</h1>
            <div className="border border-gray-300 rounded-lg overflow-hidden h-8 flex w-full">
...
export default DiversifiedProgressBar2;
