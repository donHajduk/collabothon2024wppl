...
function ForexWidget() {
    ...
    return (
        <>
            <div
                className="max-w-md p-4 bg-white rounded-lg shadow-md w-3/6  hover:shadow-lg hover:bg-gray-50 transition-transform duration-300 ease-in-out transform hover:scale-105"
