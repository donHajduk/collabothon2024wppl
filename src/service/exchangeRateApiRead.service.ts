...
const API_KEY = "b3a481bfd271bb174f15cc5b"; // Replace with your actual API Key
...
export const getExchangeRates = async (
  baseCurrency: string
): Promise<ExchangeRateApiReadResponse> => {
  try {
 ...
 */
export const getExchangeRateBetweenCurrencies = async (
  fromCurrency: string,
  toCurrency: string
): Promise<number | null> => {
  try {
